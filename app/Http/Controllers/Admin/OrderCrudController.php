...
class OrderCrudController extends CrudController {
	...
	public function setUp() {
		...
		*/
        ...
        $this->crud->addField([
            'label' => "Service book ID",
            'type' => 'select', //'type' => 'select2_multiple',
            'name' => 'service_book_id',
            'entity' => 'servicebook', // the method that defines the relationship in your Model
            'attribute' => 'gos_number', // foreign key attribute that is shown to user
            'model' => "App\Models\ServiceBook", // foreign key model
        ]);
